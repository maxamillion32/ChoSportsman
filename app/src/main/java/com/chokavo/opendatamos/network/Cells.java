...
public class Cells {
    ...
    @Expose
    private List<com.chokavo.opendatamos.network.NameOfCarrier> NameOfCarrier = new ArrayList<com.chokavo.opendatamos.network.NameOfCarrier>();
     ...
     *     The NameOfCarrier
     */
    public List<com.chokavo.opendatamos.network.NameOfCarrier> getNameOfCarrier() {
     ...
     *     The NameOfCarrier
     */
    public void setNameOfCarrier(List<com.chokavo.opendatamos.network.NameOfCarrier> NameOfCarrier) {
