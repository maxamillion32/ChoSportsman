 ...
 */
public class CalendarActivityOld extends NavigationDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCalendarView.setOnMonthChangeListener(new FlexibleCalendarView.OnMonthChangeListener() {
            ...
            public void onMonthChange(int year, int month, int direction) {
                ...
                Toast.makeText(CalendarActivityOld.this, cal.getDisplayName(Calendar.MONTH, Calendar.SHORT, Locale.ENGLISH) + " " + year, Toast.LENGTH_SHORT).show();
            }
        });
